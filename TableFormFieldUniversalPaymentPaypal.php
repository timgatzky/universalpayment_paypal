 ...
 * tl_form_field
 */
class TableFormFieldUniversalPaymentPaypal extends \Backend
{
	/**
	 * @var
	 */
	...
	public function modifyPalette(\DataContainer $objDC)
	{
		...
		$GLOBALS['TL_DCA']['tl_form_field']['subpalettes']['universalPaymentAddSettings'] = 'up_paypalEmail,up_paypalJumpToComplete,up_paypalUrlParams,up_paypalDebug';
