 ...
 * tl_module
 */
class TableModuleUniversalPaymentPaypal extends \Backend
{
	/**
	 * @var
	 */
	...
	public function modifyPalette(\DataContainer $objDC)
	{
		...
		$GLOBALS['TL_DCA']['tl_module']['palettes']['universalpayment'] = str_replace
		(
			...
			$GLOBALS['TL_DCA']['tl_module']['palettes']['universalpayment']
		);
	}
